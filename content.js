...
function injectNoteButton() {
  ...
  noteButton.addEventListener("mouseenter", () => {
    noteButton.style.background = "#cc0000";
  ...
  noteButton.addEventListener("mouseleave", () => {
    noteButton.style.background = "#ff0000";
...
function showNoteSavedToast(note) {
  ...
  toast.innerHTML = `
    ...
    <div style="margin-top: 10px; font-size: 11px;">
      <a href="${escapeHtmlForContent(note.timestampedUrl)}" style="color: #ff0000; font-weight: 600; text-decoration: none;">Copy link</a>
    </div>
  `;
